...
class SmartWordlistManager:
    ...
    def download_wordlist(self, wordlist_info: WordlistInfo, 
        ...
        if local_path.exists() and not force:
            print(f"[OK] {wordlist_info.name} already exists")
            wordlist_info.local_path = str(local_path)
            wordlist_info.downloaded = True
            return True
        
        print(f"[INFO] Downloading {wordlist_info.name} ({wordlist_info.size_mb}MB)...")
        ...
        try:
            ...
            wordlist_info.local_path = str(local_path)
            wordlist_info.downloaded = True
            print(f"[OK] Downloaded {wordlist_info.name}")
            return True
            
        except Exception as e:
            print(f"[ERROR] Failed to download {wordlist_info.name}: {str(e)}")
            return False
    ...
    def download_essential_wordlists(self) -> bool:
        ...
        print(f"[INFO] Downloaded {success_count}/{len(essential)} essential wordlists")
    ...
    def create_custom_wordlist(self, name: str, words: List[str]) -> bool:
        ...
        try:
            ...
            print(f"[OK] Created custom wordlist: {custom_path}")
            return True
        except Exception as e:
            print(f"[ERROR] Failed to create custom wordlist: {str(e)}")
            return False
